...
<html>
    <head>
        ...
        <link href="<?php echo site_url('style/ph1/lib/smoke/smoke.min.css');?>" rel="stylesheet">
...
<nav class="navbar navbar-default navbar-fixed-top am-top-header">
  <div class="container menure">
    ...
    font-size: 18px;"><?php echo $website->title;?></b></a>
          </div><a href="javascript:;" data-toggle="collapse" data-target="#am-navbar-collapse" class="am-toggle-top-header-menu collapsed"><span class="icon s7-more"></span></a>
          ...
          <div id="am-navbar-collapse" class="collapse navbar-collapse ">
            ...
            ?>
              ...
              <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="<?php echo site_url(); ?>public/media/<?php echo $this->ion_auth->user()->row()->pics;?>"> <?php echo $this->ion_auth->user()->row()->first_name;?><span class="angle-down s7-angle-down"></span></a>
            ...
            <?php } else { ?>
               ...
               <li class="dropdown"><a href="javascript:;" data-modal="login-modal" class="md-trigger">Login</a>
